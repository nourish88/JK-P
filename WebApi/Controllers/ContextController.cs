    ...
    public class ContextController : ControllerBase
    {
        ...
        public IActionResult Seed()
        {
            ...
            try
            {
                ...
                {
                    new OlayIhbar { Id = 1, IhbarId = 1, OlayId = 1, OlaySira = 1 },
                    new OlayIhbar { Id = 2, IhbarId = 2, OlayId = 2, OlaySira = 1 },
                    new OlayIhbar { Id = 3, IhbarId = 2, OlayId = 3, OlaySira = 2 },
                    new OlayIhbar { Id = 4, IhbarId = 3, OlayId = 4, OlaySira = 1 }
                };
